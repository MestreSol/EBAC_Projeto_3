...
function setDoneTask() {
  $(".task-list").on("click", "#doneBTN", function () {
    ...
    task
      .find(".actions")
      .html(
        '<button id="undoneBTN">Undone</button><button>Edit</button><button>Delete</button>',
      );
...
function setUndoneTask() {
  $(".task-list").on("click", "#undoneBTN", function () {
    ...
    task
      .find(".actions")
      .html(
        '<button id="doneBTN">Done</button><button disabled>Edit</button><button disabled>Delete</button>',
      );
